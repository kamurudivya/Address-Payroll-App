    ...
    <div class="form-content">
        <form class="form" action="#" onsubmit="save(event)">
                ...
                <div class="profile-radio-content">
                    <label>
                        <input type="radio" id="profile1" name="profile" value="../assets/profile-images/Ellipse -3.png"
                            required/>
                        <img class="profile" id="image1" src="../assets/profile-images/Ellipse -3.png"  alt="My Awesome Image"/>
                    </label>
                    <label>
                        <input type="radio" id="profile2" name="profile" value="../assets/profile-images/Ellipse -1.png"
                            required/>
                        <img class="profile" id="image2" src="../assets/profile-images/Ellipse -1.png" alt="My Awesome Image"/>
                    </label>
                    <label>
                        <input type="radio" id="profile3" name="profile" value="../assets/profile-images/Ellipse -8.png"
                            required/>
                        <img class="profile" id="image3" src="../assets/profile-images/Ellipse -8.png"  alt="My Awesome Image"/>
                    </label>
                    <label/>
                        <input type="radio" id="profile4" name="profile" value="../assets/profile-images/Ellipse -7.png"
                            required/>
                        <img class="profile" id="image4" src="../assets/profile-images/Ellipse -7.png"  alt="My Awesome Image"/>
                </div>
            </div>
            <div class="row-content">
            ...
            <div class="buttonParent">
                <a href="../html/home.html" class="resetButton button cancelButton">Cancel</a>
